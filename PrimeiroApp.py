...
#
#Para rodar o ap: python -m streamlit run PrimeiroApp.py
...
st.subheader('Este é um subheader: _streamlit_é :red[legal]')
...
with st.expander('Expandir cidades'):
    escoljidas = st.multiselect('Seleciona as cidades', cidades, padroes)
